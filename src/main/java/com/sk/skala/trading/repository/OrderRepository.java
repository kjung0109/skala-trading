...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("""
            ...
            where o.stock.id = :stockId
              and o.side = com.sk.skala.trading.domain.OrderSide.SELL
              and o.status in (com.sk.skala.trading.domain.OrderStatus.OPEN,
                               com.sk.skala.trading.domain.OrderStatus.PARTIALLY_FILLED)
              and o.price <= :price
    ...
    @Query("""
            ...
            join fetch o.account
            where o.stock.id = :stockId
              and o.side = com.sk.skala.trading.domain.OrderSide.BUY
              and o.status in (com.sk.skala.trading.domain.OrderStatus.OPEN,
                               com.sk.skala.trading.domain.OrderStatus.PARTIALLY_FILLED)
              and o.price >= :price
              and o.account.accountId <> :accountId
